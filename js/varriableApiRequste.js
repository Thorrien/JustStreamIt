    ...
    try {
        ...
        films.forEach((film, index) => {
            ...
            if (index < 2) {
                ...
                filmDiv.classList.add('col-10', 'col-lg-4', 'col-sm-6', 'film-thumbnail4', 'd-none', 'd-md-block');
            } else {
                filmDiv.classList.add('col-10', 'col-lg-4', 'col-sm-6', 'film-thumbnail4', 'd-none', 'd-lg-block');
            }         
